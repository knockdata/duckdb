...
export default [
	...
	{ os: "windows-latest", platform: "win32", arch: "x64", vcpkgTriplet: "x64-windows-static-md", rustTarget: "x86_64-pc-windows-msvc" },
	{ os: "windows-11-arm", platform: "win32", arch: "arm64", vcpkgTriplet: "arm64-windows-static-md", rustTarget: "aarch64-pc-windows-msvc" },
]
